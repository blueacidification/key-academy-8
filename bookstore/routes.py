...
def load_books():
    """Load and return the list of books from the JSON data file."""
    with open('bookstore/books.json', 'r', encoding='utf-8') as file:
        return json.load(file)


def save_books(books)
    """Save the list of books to the JSON data file."""
    with open('bookstore/books.json', 'w', encoding='utf-8') as file:
